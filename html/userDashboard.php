...
<body>
    ...
    <nav class="sidebar">
        <ul>
            <li><a href="userDashboard.html" class="sidebar-link active">Booking Details</a></li>
            <li><a href="userFeedback.html" class="sidebar-link">Share Feedback</a></li>
            ...
            <table class="booking-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>2025-08-20</td>
                        <td>Upcoming</td>
                        <td><button class="view-btn">View Details</button>
                        <button class="cancel-btn">Cancel Booking</button></td>
                    </tr>
                    <tr>
                        <td>BK12347</td>
