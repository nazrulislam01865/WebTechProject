...
<body>
    <header>
        ...
        <a href="html/login.html" class="logout-btn"><i class = "fa-solid fa-user-circle"></i> UserName</a>
        </div>
    </header>

    <nav class="sidebar">
        <ul>
            <li><a href="userDashboard.html" class="sidebar-link">Booking Details</a></li>
            <li><a href="userFeedback.html" class="sidebar-link active">Share Feedback</a></li>
            <li><a href="userAccountSettings.html" class="sidebar-link">Account Settings</a></li>
        </ul>
    </nav>
        ...
        <section id="feedback" class="section">
            ...
            <form class="feedback-form">
                ...
                <select id="booking-id">
                    ...
                    <option>BK12345 - Dhaka to Rajshahi</option>
                    <option>BK12346 - Dhaka to Barisal</option>
                    <option>BK12347 - Dhaka to Cox's Bazar</option>
                </select>
                ...
                <textarea id="comments" placeholder="Share your experience" rows="5"></textarea>
