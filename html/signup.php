        ...
        <div class="container">
            ...
            <div class="rightSide">
                ...
                <form action="signup.php" method="POST">
                    ...
                    <div class="input-box">
                        <input type="email" placeholder="Email" name="email" style="width: 250px; max-width: 250px;" value="<?php echo htmlspecialchars($form_data['email']); ?>"> <br>
                        <?php if (isset($errors['email'])): ?>
                            <span style="color: red; font-size: 0.8em;"><?php echo htmlspecialchars($errors['email']); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="input-box">
                        <input type="text" placeholder="Phone Number" name="phone" style="width: 250px; max-width: 250px;" value="<?php echo htmlspecialchars($form_data['phone']); ?>"> <br>
                        <?php if (isset($errors['phone'])): ?>
                            <span style="color: red; font-size: 0.8em;"><?php echo htmlspecialchars($errors['phone']); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="input-box">
                        <input type="text" placeholder="NID Number" name="nid" style="width: 250px; max-width: 250px;" value="<?php echo htmlspecialchars($form_data['nid']); ?>"> <br>
                    ...
                    <div class="input-box">
                        <input type="password" placeholder="Confirm Password" name="confirm_password" style="width: 250px; max-width: 250px;">
                        <br>
