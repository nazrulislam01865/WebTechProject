...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // If no errors, store form data in session and redirect
    if (empty($errors)) {
...
<head>
    ...
    <style>
        ...
        .dashboard-btn.enabled {
            background-color: #007bff;
        }
        .dashboard-btn.enabled:hover {
            background-color: #0056b3;
        }
    ...
    <header>
        ...
        <div class="header-right">
            ...
            <?php if ($is_logged_in): ?>
                ...
                <a href="./screens/userDashboard.php" class="dashboard-btn enabled">Dashboard</a>
            <?php else: ?>
                ...
                <a href="#" class="dashboard-btn disabled">Dashboard</a>
            <?php endif; ?>
        </div>
    </header>
    <img class="backgroundImage" src="picture/indexBackground.jpg" alt="Background Image">
